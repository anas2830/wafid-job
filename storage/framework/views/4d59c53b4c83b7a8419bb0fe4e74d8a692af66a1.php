...
<section class="site-section bg-light hero-area">
    ...
    <div class="container-fluid p-0">
        <div class="row align-items-stretch retro-layout-2">
            <div class="col-lg-12">
                <div class="hero-bg">
                    <img class="img-fluid w-100" src="<?php echo e(asset('uploads/bg/hero-bg-3.jpg')); ?>" class="" alt="">
...
<section class="about-us-area">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="about-us-img-wrap " data-aos="fade-up">
                    <img class="img-fluid w-100 h-100" src="<?php echo e(asset('uploads/bg/Wafid_Helping_team.webp')); ?>" class=""
                        alt="">
                </div>
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="about-us-img-wrap " data-aos="fade-up">
                    <img class="img-fluid w-100 h-100" src="<?php echo e(asset('uploads/bg/depositphotos.webp')); ?>" class=""
                        alt="">
                </div>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-lg-6 col-md-6">
                <div class="about-us-img-wrap " data-aos="fade-up">
                    <img class="img-fluid w-100 h-100" src="<?php echo e(asset('uploads/bg/interview-for-job-1.webp')); ?>" class=""
                        alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-md-3 d-flex">
                    <div class="single-process first text-center align-self-stretch">
                        <div class="progress-img-wrap">
                            <img class="img-fluid"
                                src="<?php echo e(asset('uploads/icons/icons8-signing-a-document-48.png.webp')); ?>" class="" alt="">
                        </div>
                ...
                <div class="col-md-3 d-flex">
                    <div class="single-process secend text-center align-self-stretch">
                        <div class="progress-img-wrap">
                            <img class="img-fluid" src="<?php echo e(asset('uploads/icons/services.png.webp')); ?>" class="" alt="">
                        </div>
                ...
                <div class="col-md-3 d-flex">
                    <div class="single-process thard text-center align-self-stretch">
                        <div class="progress-img-wrap">
                            <img class="img-fluid" src="<?php echo e(asset('uploads/icons/Tirra_icon.png.webp')); ?>" class=""
                                alt="">
                        </div>
                ...
                <div class="col-md-3 d-flex">
                    <div class="single-process last text-center align-self-stretch">
                        <div class="progress-img-wrap">
                            <img class="img-fluid"
                                src="<?php echo e(asset('uploads/icons/istockphoto-1224838022-612x612-1.jpg.webp')); ?>" class=""
                                alt="">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center" data-aos="fade-left">
                <div class="company-wrok-process-img">
                    <img class="img-fluid" src="<?php echo e(asset('uploads/bg/Pi-charrt-for-web-e1670320603510.webp')); ?>" class=""
                        alt="">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="job-new-list" data-aos="zoom-in-up">
                    <div class="vc-thumb">
                        <img class="img-fluid" src="<?php echo e(asset('uploads/bg/adwords.png')); ?>" class="" alt="" title="">
                    </div>
                ...
                <div class="job-new-list" data-aos="zoom-in-up">
                    <div class="vc-thumb">
                        <img class="img-fluid" src="<?php echo e(asset('uploads/bg/asana.png')); ?>" class="" alt="" title="">
                    </div>
                    <div class="vc-content">
                        <h5 class="title"><a href="job-detail.html">Web Developer</a><span class="j-full-time">Full
                                Time</span></h5>
                ...
                <div class="job-new-list" data-aos="zoom-in-up">
                    <div class="vc-thumb">
                        <img class="img-fluid" src="<?php echo e(asset('uploads/bg/drive.png')); ?>" class="" alt="" title="">
                    </div>
                    <div class="vc-content">
                        <h5 class="title"><a href="job-detail.html">Web Developer</a><span class="j-full-time">Full
                                Time</span></h5>
                ...
                <div class="job-new-list" data-aos="zoom-in-up">
                    <div class="vc-thumb">
                        <img class="img-fluid" src="<?php echo e(asset('uploads/bg/google.png')); ?>" class="" alt="" title="">
                    </div>
                    <div class="vc-content">
                        <h5 class="title"><a href="job-detail.html">Web Developer</a><span class="j-full-time">Full
                                Time</span></h5>
                ...
                <div class="job-new-list">
                    <div class="vc-thumb">
                        <img class="img-fluid" src="<?php echo e(asset('uploads/bg/photos.png')); ?>" class="" alt="" title="">
                    </div>
                    <div class="vc-content">
                        <h5 class="title"><a href="job-detail.html">Web Developer</a><span class="j-full-time">Full
                                Time</span></h5>
                ...
                <div class="job-new-list" data-aos="zoom-in-up">
                    <div class="vc-thumb">
                        <img class="img-fluid" src="<?php echo e(asset('uploads/bg/paypal.png')); ?>" class="" alt="" title="">
                    </div>
                    <div class="vc-content">
                        <h5 class="title"><a href="job-detail.html">Web Developer</a><span class="j-full-time">Full
                                Time</span></h5>
        ...
        <div class="row">
                ...
                <div class="testimonial">
                    ...
                    <div class="bq-author">
                        <figure class="author-img">
                            <img src="<?php echo e(asset('uploads/bg/testi-img1.png')); ?>" alt="" title="">
                        </figure>
                        <h6>John Doe</h6>
            ...
            <div class="col-md-6" data-aos="fade-left">
                <div class="testimonial">
                    ...
                    <div class="bq-author">
                        <figure class="author-img">
                            <img src="<?php echo e(asset('uploads/bg/testi-img2.png')); ?>" alt="" title="">
                        </figure>
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-lg-3 col-md-4 col-12 mb-30 d-flex">
                <div class="bakix-features  align-self-stretch">
                    <img src="<?php echo e(asset('uploads/slider/Alshaya.webp')); ?>" alt="" title="">
                    <h4>Alshaya</h4>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-12 mb-30 d-flex">
                <div class="bakix-features align-self-stretch">
                    <img src="<?php echo e(asset('uploads/slider/download.webp')); ?>" alt="" title="">
                    <h4>Landmark</h4>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-12 mb-30 d-flex">
                <div class="bakix-features align-self-stretch">
                    <img src="<?php echo e(asset('uploads/slider/Almarai.webp')); ?>" alt="" title="">
                    <h4>Almarai</h4>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-12 mb-30 d-flex">
                <div class="bakix-features align-self-stretch">
                    <img src="<?php echo e(asset('uploads/slider/download-3.webp')); ?>" alt="" title="">
                    <h4>Maaden</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-sm-6 col-lg-4">
                <div class="blog-item">
                    <div class="top">
                        <a href="#">
                            <img src="<?php echo e(asset('uploads/bg/how-to-use-al-wafid.webp')); ?>" alt="" title="">
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="blog-item">
                    <div class="top">
                        <a href="#">
                            <img src="<?php echo e(asset('uploads/bg/Services-1.webp')); ?>" alt="" title="">
                        </a>
                    </div>
            ...
            <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                <div class="blog-item">
                    <div class="top">
                        <a href="#">
                            <img src="<?php echo e(asset('uploads/bg/WhatsApp-Image-2023-05-02-at-12.17.06-AM.webp')); ?>" alt=""
                                title="">
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\wafid-job\resources\views/website/home.blade.php ENDPATH**/ ?>