            ...
            <div class="row justify-content-center m-0">
                <div class="col-md-10 m-auto">
                    <div class="card" style="margin:4% 0%">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('sign-up')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus placeholder="Eneter your full name">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row">
                                            <label for="password" class="col-md-3 col-form-label text-md-right required p-0"><?php echo e(__('Password')); ?></label>
                                            <div class="col-md-9">
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\wafid\resources\views/auth/register.blade.php ENDPATH**/ ?>