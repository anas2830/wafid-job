                        ...
                        <div class="profile-input-wrap">
                            <div class="mb-3 mt-3">
                                ...
                                <?php if(isset($userDocument) && isset($userDocument->passport_original_name)): ?>
                                    <span style="color:#16a549">Already uploaded: <?php echo e(@$userDocument->passport_original_name); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="mb-3 mt-3">
                                ...
                                <?php if(isset($userDocument) && isset($userDocument->medical_original_name)): ?>
                                    <span style="color:#16a549">Already uploaded: <?php echo e(@$userDocument->medical_original_name); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="mb-3 mt-3">
                                ...
                                <?php if(isset($userDocument) && isset($userDocument->bank_original_name)): ?>
                                    <span style="color:#16a549">Already uploaded: <?php echo e(@$userDocument->bank_original_name); ?></span>
                                <?php endif; ?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\wafid-job\resources\views/website/company-dashboard.blade.php ENDPATH**/ ?>