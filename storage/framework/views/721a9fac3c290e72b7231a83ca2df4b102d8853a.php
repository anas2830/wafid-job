...
<?php echo $__env->make('googleAnalytics', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <body>
    ...
    <h1><?php echo e(Helper::translate('Hello World')); ?></h1>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-3 py-lg-0">
          ...
          <a class="nav-item nav-link">
            <select class="form-select changeLanguage selectpicker" data-width="fit">
              <option value="en" <?php echo e(session()->get('locale') == 'en' ? 'selected' : ''); ?>><span class="flag-icon flag-icon-us me-1"></span>English</option>
              ...
              <option value="iw" <?php echo e(session()->get('locale') == 'iw' ? 'selected' : ''); ?>>Hebrew</option>
          </select>
    ...
    <?php if(isset($section_name_array) && in_array('second_template_home_section', $section_name_array)): ?>
        ...
        <div class="container-fluid p-0 mb-5 wow fadeIn template_sections active_sections" id="second_template_home_section" type="<?php echo e($template_view); ?>" data-wow-delay="0.1s">
                        ...
                        <div class="row justify-content-center">
                            <?php if(isset($fill_up_info['second_template_home_first_img_content'])): ?> 
                                ...
                                <div class="col-12 col-lg-10" class="second_template_home_first_img_content <?php echo e($template_view); ?>_view">
                                  <?php echo Helper::translate($fill_up_info['second_template_home_first_img_content']); ?>
                            ...
                            <?php else: ?> 
                                <div class="col-12 col-lg-10 second_template_home_first_img_content <?php echo e($template_view); ?>_view" type="html" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_home_first_img_content]">
                                    <h5 class="text-light text-uppercase mb-3 animated slideInDown"><?php echo e(Helper::translate('Welcome to Apex')); ?></h5>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="row justify-content-center">
                            <?php if(isset($fill_up_info['second_template_home_second_img_content'])): ?> 
                                ...
                                <div class="col-12 col-lg-10" class="second_template_home_second_img_content <?php echo e($template_view); ?>_view">
                                  <?php echo Helper::translate($fill_up_info['second_template_home_second_img_content']); ?>
                            ...
                            <div class="col-12 col-lg-10">
                              ...
                              <?php if(isset($fill_up_info['second_template_home_second_img_btn_text'])): ?> 
                                <a href="<?php echo e($fill_up_info['second_template_home_second_img_btn_url']); ?>" class="btn btn-primary py-3 px-5"> <?php echo e(Helper::translate($fill_up_info['second_template_home_second_img_btn_text'])); ?></a>
                              <?php else: ?> 
                                <a href="" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_home_second_img_btn_text]" class="btn btn-primary py-3 px-5 <?php echo e($template_view); ?>_view" type="link" link-name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_home_second_img_btn_url]"><?php echo e(Helper::translate('Click Here')); ?></a>
                              <?php endif; ?>
            ...
            >
                ...
                <span class="visually-hidden"><?php echo e(Helper::translate('Previous')); ?></span>
            </button>
            <button
            ...
            >
                ...
                <span class="visually-hidden"><?php echo e(Helper::translate('Next')); ?></span>
            </button>
            </div>
        </div>
        <!-- Carousel End -->
                  ...
                  <div class="d-flex flex-column justify-content-center text-center bg-primary h-100 p-3">
                    ...
                    <?php else: ?> 
                      <div class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_about_image_content]" type="html">
                        <h1 class="text-white"><?php echo e(Helper::translate('25')); ?></h1>
                        <h2 class="text-white"><?php echo e(Helper::translate('Years')); ?></h2>
                        <h5 class="text-white mb-0"><?php echo e(Helper::translate('Experience')); ?></h5>
                      </div>
                    <?php endif; ?>
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="h-100">
                <div class="border-start border-5 border-primary ps-4 mb-5">
                  <h6 class="text-body text-uppercase mb-2"><?php echo e(Helper::translate('About Us')); ?></h6>
                  ...
                  <?php else: ?> 
                    <h1 name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_about_section_heading]" class="display-6 mb-0 <?php echo e($template_view); ?>_view" type="html"><?php echo e(Helper::translate('Unique Solutions For Residentials & Industries!')); ?></a>
                  <?php endif; ?>
                ...
                <?php if(isset($fill_up_info['second_template_about_section_content'])): ?> 
                  ...
                  <?php echo Helper::translate($fill_up_info['second_template_about_section_content']); ?>
                ...
                <?php else: ?> 
                  ...
                  <div class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_about_section_content]" type="html">
                    <p>
                      <?php echo e(Helper::translate('Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit.
        ...
        <div class="row g-5 align-items-end mb-5">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="border-start border-5 border-primary ps-4">
              <h6 class="text-body text-uppercase mb-2"><?php echo e(Helper::translate('Our Services')); ?></h6>

              <?php if(isset($fill_up_info['second_template_service_section_heading'])): ?> 
                <h1 class="display-6 mb-0"><?php echo e(Helper::translate($fill_up_info['second_template_service_section_heading'])); ?></h1>
              <?php else: ?> 
                <h1 class="display-6 mb-0 <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_heading]" type="text"><?php echo e(Helper::translate('Construction And Renovation Solutions')); ?></h1>
              <?php endif; ?>
            ...
            <div class="service-item bg-light overflow-hidden h-100">
              ...
              <div class="service-text position-relative text-center h-100 p-4">
                ...
                <?php if(isset($fill_up_info['second_template_service_section_first_header'])): ?> 
                  <h5 class="mb-3"><?php echo e(Helper::translate($fill_up_info['second_template_service_section_first_header'])); ?></h5>
                <?php else: ?> 
                  <h5 class="mb-3 <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_first_header]" type="text"><?php echo e(Helper::translate('Building Construction')); ?></h5>
                <?php endif; ?>

                <?php if(isset($fill_up_info['second_template_service_section_first_content'])): ?> 
                <?php echo Helper::translate( $fill_up_info['second_template_service_section_first_content']); ?>
                ...
                <?php else: ?> 
                  <div class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_first_content]" type="html">
                    <p>
                      <?php echo e(Helper::translate('Tempor erat elitr rebum at clita dolor diam ipsum sit diam
                      amet diam et eos')); ?>
                ...
                <?php if(isset($fill_up_info['second_template_service_section_first_button'])): ?> 
                  <a href="<?php echo e($fill_up_info['second_template_service_section_first_link']); ?>" class="small"><?php echo e(Helper::translate( $fill_up_info['second_template_service_section_first_button'])); ?></a><i class="fa fa-arrow-right ms-3" style="color:#FDA12B"></i
                    >
                <?php else: ?> 
                  <a class="small <?php echo e($template_view); ?>_view" href="" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_first_button]"
                    link-name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_first_link]"><?php echo e(Helper::translate('READ MORE')); ?></a><i class="fa fa-arrow-right ms-3" style="color:#FDA12B"></i
                      >
                <?php endif; ?>
            ...
            <div class="service-item bg-light overflow-hidden h-100">
              ...
              <div class="service-text position-relative text-center h-100 p-4">
                <?php if(isset($fill_up_info['second_template_service_section_second_header'])): ?> 
                  <h5 class="mb-3"><?php echo e(Helper::translate($fill_up_info['second_template_service_section_second_header'])); ?></h5>
                <?php else: ?> 
                  <h5 class="mb-3 <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_second_header]" type="text"><?php echo e(Helper::translate('Building Construction')); ?></h5>
                <?php endif; ?>
                
                <?php if(isset($fill_up_info['second_template_service_section_second_content'])): ?> 
                  <?php echo Helper::translate($fill_up_info['second_template_service_section_second_content']); ?>
                ...
                <?php if(isset($fill_up_info['second_template_service_section_second_button'])): ?> 
                  <a href="<?php echo e($fill_up_info['second_template_service_section_second_link']); ?>" class="small"><?php echo e(Helper::translate( $fill_up_info['second_template_service_section_second_button'])); ?></a><i class="fa fa-arrow-right ms-3" style="color:#FDA12B"></i
                    >
                <?php else: ?> 
                  <a class="small <?php echo e($template_view); ?>_view" href="" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_second_button]"
                    link-name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_second_link]"><?php echo e(Helper::translate('READ MORE')); ?></a><i class="fa fa-arrow-right ms-3" style="color:#FDA12B"></i
                      >
                <?php endif; ?>
            ...
            <div class="service-item bg-light overflow-hidden h-100">
              ...
              <div class="service-text position-relative text-center h-100 p-4">
                <?php if(isset($fill_up_info['second_template_service_section_third_header'])): ?> 
                  <h5 class="mb-3"><?php echo e(Helper::translate( $fill_up_info['second_template_service_section_third_header'])); ?></h5>
                <?php else: ?> 
                  <h5 class="mb-3 <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_third_header]" type="text"><?php echo e(Helper::translate('Building Construction')); ?></h5>
                <?php endif; ?>
                
                <?php if(isset($fill_up_info['second_template_service_section_third_content'])): ?> 
                  <?php echo Helper::translate($fill_up_info['second_template_service_section_third_content']); ?>
                ...
                <?php if(isset($fill_up_info['second_template_service_section_third_button'])): ?> 
                  <a href="<?php echo e($fill_up_info['second_template_service_section_third_link']); ?>" class="small"><?php echo e(Helper::translate($fill_up_info['second_template_service_section_third_button'])); ?></a><i class="fa fa-arrow-right ms-3" style="color:#FDA12B"></i
                    >
                <?php else: ?> 
                  <a class="small <?php echo e($template_view); ?>_view" href="" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_third_button]"
                    link-name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_service_section_third_link]"><?php echo e(Helper::translate('READ MORE')); ?></a><i class="fa fa-arrow-right ms-3" style="color:#FDA12B"></i
                      >
                <?php endif; ?>
    ...
    <div class="container-xxl py-5 active_sections template_sections" type="<?php echo e($template_view); ?>" id="second_template_team_section">
      <div class="container">
        <div class="row g-5 align-items-end mb-5">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="border-start border-5 border-primary ps-4">
              <h6 class="text-body text-uppercase mb-2"><?php echo e(Helper::translate('Our Team')); ?></h6>
              
                <?php if(isset($fill_up_info['second_template_team_main_heading'])): ?> 
                  <h5 class="mb-3"><?php echo e(Helper::translate($fill_up_info['second_template_team_main_heading'])); ?></h5>
                <?php else: ?> 
                  <h5 class="mb-3 <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_main_heading]" type="text"><?php echo e(Helper::translate('Our Expert Worker')); ?></h5>
                <?php endif; ?>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <?php if(isset($fill_up_info['second_template_team_main_content'])): ?> 
              <?php echo Helper::translate($fill_up_info['second_template_team_main_content']); ?>
            ...
            <div class="team-item position-relative">
              ...
              <div class="team-text bg-white p-4">
                ...
                <?php if(isset($fill_up_info['second_template_team_first_name'])): ?> 
                  <h5><?php echo e(Helper::translate($fill_up_info['second_template_team_first_name'])); ?></h5>
                <?php else: ?> 
                  <h5 class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_first_name]" type="text"><?php echo e(Helper::translate('Full Name')); ?></h5>
                <?php endif; ?>

                <?php if(isset($fill_up_info['second_template_team_first_title'])): ?> 
                  <span><?php echo e(Helper::translate($fill_up_info['second_template_team_first_title'])); ?></span>
                <?php else: ?> 
                  <span class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_first_title]" type="text"><?php echo e(Helper::translate('Engineer')); ?></span>
                <?php endif; ?>
            ...
            <div class="team-item position-relative">
              ...
              <div class="team-text bg-white p-4">
                ...
                <?php if(isset($fill_up_info['second_template_team_second_name'])): ?> 
                  <h5><?php echo e(Helper::translate($fill_up_info['second_template_team_second_name'])); ?></h5>
                <?php else: ?> 
                  <h5 class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_second_name]" type="text"><?php echo e(Helper::translate('Full Name')); ?></h5>
                <?php endif; ?>

                <?php if(isset($fill_up_info['second_template_team_second_title'])): ?> 
                  <span><?php echo e(Helper::translate($fill_up_info['second_template_team_second_title'])); ?></span>
                <?php else: ?> 
                  <span class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_second_title]" type="text"><?php echo e(Helper::translate('Engineer')); ?></span>
                <?php endif; ?>
            ...
            <div class="team-item position-relative">
              ...
              <div class="team-text bg-white p-4">
                ...
                <?php if(isset($fill_up_info['second_template_team_three_name'])): ?> 
                  <h5><?php echo e(Helper::translate($fill_up_info['second_template_team_three_name'])); ?></h5>
                <?php else: ?> 
                  <h5 class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_three_name]" type="text"><?php echo e(Helper::translate('Full Name')); ?></h5>
                <?php endif; ?>

                <?php if(isset($fill_up_info['second_template_team_three_title'])): ?> 
                  <span><?php echo e(Helper::translate($fill_up_info['second_template_team_three_title'])); ?></span>
                <?php else: ?> 
                  <span class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_team_three_title]" type="text"><?php echo e(Helper::translate('Engineer')); ?></span>
                <?php endif; ?>
      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="border-start border-5 border-primary ps-4 mb-5">
              <h6 class="text-body text-uppercase mb-2"><?php echo e(Helper::translate('Testimonial')); ?></h6>
           
              <?php if(isset($fill_up_info['second_template_testimonial_main_heading'])): ?> 
                <h1 class="display-6 mb-0"><?php echo e(Helper::translate($fill_up_info['second_template_testimonial_main_heading'])); ?></h1>
              <?php else: ?> 
                <h1 class="display-6 mb-0 <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_main_heading]" type="text"><?php echo e(Helper::translate('What Our Happy Clients Say!')); ?></h1>
              <?php endif; ?>
            ...
            <div>
              <?php echo Helper::translate($fill_up_info['second_template_testimonial_content']); ?>
            ...
            <?php else: ?> 
              <div class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_content]" type="html">
                ...
                <?php if(isset($fill_up_info['second_template_testimonial_slider_first_content'])): ?> 
                  <?php echo Helper::translate($fill_up_info['second_template_testimonial_slider_first_content']); ?>
                ...
                <?php else: ?> 
                  <div class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_slider_first_content]" type="html">
                    <p class="mb-4">
                      <?php echo e(Helper::translate('Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat
            ...
            <div class="owl-carousel testimonial-carousel">
              <div class="testimonial-item">
                ...
                <?php if(isset($fill_up_info['second_template_testimonial_slider_first_name'])): ?> 
                  <h5><?php echo e(Helper::translate($fill_up_info['second_template_testimonial_slider_first_name'])); ?></h5>
                <?php else: ?> 
                  <h5 class=" <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_slider_first_name]" type="text"><?php echo e(Helper::translate('Client Name')); ?></h5>
                <?php endif; ?>

                <?php if(isset($fill_up_info['second_template_testimonial_slider_first_title'])): ?> 
                  <span><?php echo e(Helper::translate($fill_up_info['second_template_testimonial_slider_first_title'])); ?></span>
                <?php else: ?> 
                  <span class=" <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_slider_first_title]" type="text"><?php echo e(Helper::translate('Profession')); ?></span>
                <?php endif; ?>
              ...
              <div class="testimonial-item">
                ...
                <?php if(isset($fill_up_info['second_template_testimonial_slider_second_content'])): ?> 
                  <?php echo Helper::translate($fill_up_info['second_template_testimonial_slider_second_content']); ?>
                ...
                <?php if(isset($fill_up_info['second_template_testimonial_slider_second_name'])): ?> 
                  <h5><?php echo e(Helper::translate($fill_up_info['second_template_testimonial_slider_second_name'])); ?></h5>
                <?php else: ?> 
                  <h5 class=" <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_slider_second_name]" type="text"><?php echo e(Helper::translate('Client Name')); ?></h5>
                <?php endif; ?>

                <?php if(isset($fill_up_info['second_template_testimonial_slider_second_title'])): ?> 
                  <span><?php echo e(Helper::translate($fill_up_info['second_template_testimonial_slider_second_title'])); ?></span>
                <?php else: ?> 
                  <span class=" <?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_testimonial_slider_second_title]" type="text"><?php echo e(Helper::translate('Profession')); ?></span>
                <?php endif; ?>
        ...
        <div class="row g-5">
          <div class="col-lg-4 col-md-4">
            ...
            <div>
              ...
              <div>
                <?php echo Helper::translate($fill_up_info['second_template_footer_left_content']); ?>
          ...
          <div class="col-lg-4 col-md-4">
            <h4 class="text-light mb-4"><?php echo e(Helper::translate('Address')); ?></h4>

            <?php if(isset($fill_up_info['second_template_footer_middle_content'])): ?> 
            <div>
              <?php echo Helper::translate($fill_up_info['second_template_footer_middle_content']); ?>
            ...
            <?php else: ?> 
              <div class="<?php echo e($template_view); ?>_view" name="<?php echo e($template_info->template_slug); ?>_website_template_info[second_template_footer_middle_content]" type="html">
                ...
                <p>
                  <i class="fa fa-map-marker-alt me-3"></i><?php echo e(Helper::translate('123 Street, New York, USA')); ?>

                </p>
                <p><i class="fa fa-phone-alt me-3"></i><?php echo e(Helper::translate('+012 345 67890')); ?></p>
                <p><i class="fa fa-envelope me-3"></i><?php echo e(Helper::translate('info@example.com')); ?></p>
              </div>
            <?php endif; ?>
          ...
          <div class="col-lg-4 col-md-4">
            ...
            <div>
              <?php echo Helper::translate($fill_up_info['second_template_footer_right_content']); ?>
...
<?php /**PATH C:\laragon\www\laravel-blog\resources\views/website/template/second-template.blade.php ENDPATH**/ ?>