      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 order-md-2">
            <img src="<?php echo e(asset('website')); ?>/images/img_1.jpg" alt="Image" class="img-fluid">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="<?php echo e(asset('website')); ?>/images/person_1.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="<?php echo e(asset('website')); ?>/images/person_2.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="<?php echo e(asset('website')); ?>/images/person_3.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-template-site\resources\views/website/about.blade.php ENDPATH**/ ?>