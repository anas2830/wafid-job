...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('super-admin')); ?>/css/custom.css">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
          <li class="nav-item">
            <a class='nav-link <?php if($activeMenu == "profile"): ?> active <?php endif; ?>' href="<?php echo e(route('admin.adminProfile')); ?>">
                <i class="far fa-circle nav-icon"></i> <p>Profile</p>
            </a>
          </li>
          <li class="nav-item">
            <a class='nav-link <?php if($activeMenu == "template"): ?> active <?php endif; ?>' href="<?php echo e(route('admin.template')); ?>">
                <i class="far fa-circle nav-icon"></i> <p>Template</p>
            </a>
          </li>
          <li class="nav-item">
            <a class='nav-link <?php if($activeMenu == "plan"): ?> active <?php endif; ?>' href="<?php echo e(route('admin.plan')); ?>">
...
<?php /**PATH D:\xampp\htdocs\laravel-template-site\resources\views/layouts/admin.blade.php ENDPATH**/ ?>