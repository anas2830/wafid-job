...
<html lang="en">
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h3><?php echo e(GoogleTranslate::trans('Welcome To Webappfix',\App::getLocale())); ?></h3>
                <h3><?php echo e(GoogleTranslate::trans('Hello World!',\App::getLocale())); ?></h3>
            </div>
        </div>
    </div>
    ...
    <script>
        $('.changeLanguage').change(function(event){
            var url = "<?php echo e(route('google.translate.change')); ?>";
            window.location.href = url+"?lang="+$(this).val()
        })
    </script>
    </body>
</html><?php /**PATH D:\xampp\htdocs\laravel-template-site\resources\views/translate.blade.php ENDPATH**/ ?>