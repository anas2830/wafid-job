                        ...
                        @if (count($all_services) > 0)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="open-modal action-icon" modal-title="Update Service" modal-type="update" modal-size="medium" modal-class="" selector="ServiceUpdate" modal-link="{{url('services/'.$service->id.'/edit')}}"><i class="icon-pencil"></i></a>
                                    
                                    {{-- <a href="#" class="action-icon"><i class="icon-trash" id="delete" delete-link="{{url('services', [$service->id])}}">@csrf </i></a> --}}
                                </td>
                            </tr> 
                            @endforeach
                        @else
