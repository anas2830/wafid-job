              ...
              <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="card" style="margin:4% 0%">
                        <input type="hidden" value="{{$authRole}}" id="authRole" />
                        ...
                        <div class="card-body">
                            <form action="{{ route('adminProfileUpdate') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-3 col-form-label text-md-right required">{{ __('Password') }}</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-3 col-form-label text-md-right required">{{ __('Confirm Password') }}</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        @if($userInfo->photo_name != null)
                                            <img src="{{ asset('uploads/adminProfile/thumb/'.Auth::user()->photo_name) }}" />
